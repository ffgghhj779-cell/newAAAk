...
export default async function LocaleLayout({
  ...
  return (
    <html lang={locale} dir={dir} className={`${inter.variable} ${cairo.variable} ${playfair.variable}`}>
      <body className="font-sans bg-[#FAF9F6] text-[#1F2937] min-h-screen flex flex-col antialiased">
