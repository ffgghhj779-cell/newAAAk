              ...
              {visas.map((visa) => {
                ...
                return (
                  <StaggerItem key={visa.id}>
                    <Card className="overflow-hidden flex flex-col hover:shadow-2xl hover:shadow-[#7C3AED]/10 transition-all duration-500 border border-gray-100 bg-white/80 backdrop-blur-sm group hover:-translate-y-1 rounded-3xl">
                      <div className="relative h-56 w-full overflow-hidden">
                        ...
                        <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-md px-4 py-1.5 rounded-full text-sm font-semibold text-[#7C3AED] shadow-sm">
